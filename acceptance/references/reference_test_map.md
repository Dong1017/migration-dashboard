...
| --- | --- | --- | --- |
| `OP-RMSNORM-001` | RMSNorm numeric equivalence | `acceptance/references/OP-RMSNORM-001.reference.md` | Skeleton contract only; missing real golden/actual artifacts means `not_run`. |
