# PanguV2 torch_npu -> MindSpore 迁移：测试验收分析 v0.5
...
| 99 | `torch_npu._npu_flash_attention_unpad` | 是 | `4.1` | mindspore.ops.flash_attention_score | unpad 输入/输出 layout 和 padding metadata 需人工核对 |
| 100 | `torch_npu._npu_recurrent_gated_delta_rule` | 是 | `4.14` | - | 待确认/补充 golden 或 xfail 依据 |
| 101 | `torch_npu.npu_swiglu_mx_quant` | 是 | `4.5`、`4.9` | mindspore.ops.swiglu | SwiGLU 与 MX quant 融合语义需人工核对 |
| 102 | `torch_npu.npu_trans_quant_param` | 是 | `4.9` | - | quant 参数转换语义需人工核对 |
...
| [ ] `4.9` | P2 | Quant / custom dtype / MHC-MOME。 | 16, 44, 49, 52, 68, 69, 70, 89, 90, 98, 101, 102 | 12 |
...
| [ ] `4.14` | P0 | unsupported/xfail 清单。 | 14, 15, 18, 24, 25, 55, 68, 69, 70, 88, 89, 96, 98, 100, 506, 507 | 16 |
