# PanguV2 torch_npu -> MindSpore 迁移：测试验收分析 v0.4
...
| **总计** | **126** | 文档设计口径；Dashboard 执行口径为 170 个跟踪项。 |
...
本节承接 `op-analysis.md` 中 `Col I (自定义算子接入)` 的最新“是”类标签，仅纳入：`是`、`是，omni-ops-master`、`是，omni-ops-v1.5.0`。截至 v0.4，共 58 个执行 Row：`是` 44 个、`是，omni-ops-master` 6 个、`是，omni-ops-v1.5.0` 8 个。

Dashboard 中这些 Row 会展开为实际跟踪项，ID 形如 `4.1#13`；`4.1` - `4.14` 只作为能力组/折叠标题，不计入完成率。

| Row | API | 来源标签 | 覆盖 checkbox | MS 候选 | 处理口径 |
|---:|---|---|---|---|---|
| 13 | `torch.ops.custom._npu_fused_infer_attention_sink_get_max_workspace` | 是，omni-ops-v1.5.0 | `4.1` | - | 待确认/补充 golden 或 xfail 依据 |
| 14 | `torch.ops.custom.npu_aggregate_hidden` | 是，omni-ops-v1.5.0 | `4.14` | - | 待确认/补充 golden 或 xfail 依据 |
| 15 | `torch.ops.custom.npu_ai_infra_fused_causal_conv1d` | 是，omni-ops-master | `4.14` | - | 待确认/补充 golden 或 xfail 依据 |
| 16 | `torch.ops.custom.npu_ai_infra_kv_quant_sparse_falsh_attention` | 是，omni-ops-master | `4.4`、`4.9` | mindspore.ops.sparse_flash_attention | 自定义接口，KV quant 参数需人工核对 |
| 17 | `torch.ops.custom.npu_ai_infra_kv_rmsnorm_rope_cache_v2` | 是，omni-ops-master | `4.3` | - | 待确认/补充 golden 或 xfail 依据 |
| 18 | `torch.ops.custom.npu_ai_infra_manifold_constrained_hyper_connection_post` | 是，omni-ops-v1.5.0 | `4.14` | - | 待确认/补充 golden 或 xfail 依据 |
| 19 | `torch.ops.custom.npu_ai_infra_scatter_block_update_` | 是，omni-ops-master | `4.2` | - | 待确认/补充 golden 或 xfail 依据 |
| 20 | `torch.ops.custom.npu_ai_infra_sparse_flash_attention_pioneer` | 是，omni-ops-master | `4.4` | mindspore.ops.sparse_flash_attention | 自定义接口，参数需人工核对 |
| 21 | `torch.ops.custom.npu_fused_infer_attention_sink` | 是，omni-ops-v1.5.0 | `4.1` | mindspore.ops.fused_infer_attention_score | 自定义 sink 接口，需按推理注意力语义改写 |
| 23 | `torch.ops.custom.npu_lightning_indexer_enhance` | 是，omni-ops-v1.5.0 | `4.4` | mindspore.ops.lightning_indexer | 待确认/补充 golden 或 xfail 依据 |
| 24 | `torch.ops.custom.npu_manifold_constrained_hyper_connection_pre` | 是，omni-ops-v1.5.0 | `4.14` | - | 待确认/补充 golden 或 xfail 依据 |
| 25 | `torch.ops.custom.npu_sinkhorn` | 是，omni-ops-v1.5.0 | `4.14` | - | 待确认/补充 golden 或 xfail 依据 |
| 26 | `torch.ops.custom.npu_sparse_flash_attention_enhance` | 是，omni-ops-v1.5.0 | `4.4` | mindspore.ops.sparse_flash_attention | 待确认/补充 golden 或 xfail 依据 |
| 38 | `torch_npu._npu_attention_pioneer` | 是 | `4.1` | - | 待确认/补充 golden 或 xfail 依据 |
| 40 | `torch_npu._npu_attention_pioneer_get_max_workspace` | 是 | `4.1` | - | 待确认/补充 golden 或 xfail 依据 |
| 41 | `torch_npu._npu_fused_infer_attention_score_get_max_workspace` | 是 | `4.1` | mindspore.ops.fused_infer_attention_score | 待确认/补充 golden 或 xfail 依据 |
| 42 | `torch_npu._npu_fused_infer_attention_score_v2_get_max_workspace` | 是 | `4.1` | mindspore.ops.fused_infer_attention_score | 待确认/补充 golden 或 xfail 依据 |
| 43 | `torch_npu._npu_fused_infer_attention_score_v2_infer_output` | 是 | `4.1` | mindspore.ops.fused_infer_attention_score | 待确认/补充 golden 或 xfail 依据 |
| 44 | `torch_npu._npu_kv_quant_sparse_flash_attention_pioneer` | 是 | `4.4`、`4.9` | - | 待确认/补充 golden 或 xfail 依据 |
| 45 | `torch_npu.npu_add_rms_norm` | 是 | `4.5` | mindspore.ops.add_rms_norm | 待确认/补充 golden 或 xfail 依据 |
| 46 | `torch_npu.npu_apply_rotary_pos_emb` | 是 | `4.5` | mindspore.ops.rotary_position_embedding | 代码已有，未对外；参数语义需人工核对 |
| 48 | `torch_npu.npu_attention_update` | 是 | `4.1`、`4.2` | mindspore.ops.fused_infer_attention_score; mind... | 待确认/补充 golden 或 xfail 依据 |
| 49 | `torch_npu.npu_dequant_swiglu_quant` | 是 | `4.9` | mindspore.ops.dequant_swiglu_quant | 代码已有，未对外；Ascend 融合算子，参数不同 |
| 52 | `torch_npu.npu_dynamic_quant` | 是 | `4.9` | mindspore.ops.dynamic_quant_ext | 代码已有，未对外；参数不同 |
| 55 | `torch_npu.npu_fused_causal_conv1d` | 是 | `4.14` | - | 待确认/补充 golden 或 xfail 依据 |
| 56 | `torch_npu.npu_fused_infer_attention_score` | 是 | `4.1` | mindspore.ops.fused_infer_attention_score; mindspore.ops.speed_fusion_attention | 推理融合注意力公开接口，参数和 layout 需核对 |
| 58 | `torch_npu.npu_fused_infer_attention_score_v2` | 是 | `4.1` | mindspore.ops.fused_infer_attention_score; mindspore.ops.speed_fusion_attention | v2 参数和 layout 需核对 |
| 60 | `torch_npu.npu_fusion_attention` | 是 | `4.1` | mindspore.ops.flash_attention_score | 参数和 layout 有差异 |
| 61 | `torch_npu.npu_grouped_matmul` | 是 | `4.6` | mindspore.ops.grouped_matmul | 代码已有，未对外；Ascend 融合算子，参数不同 |
| 63 | `torch_npu.npu_grouped_matmul_finalize_routing` | 是 | `4.6` | - | 代码已有，未对外；未找到单一对等接口，可拆分替代 |
| 65 | `torch_npu.npu_interleave_rope` | 是 | `4.5` | mindspore.ops.rotary_position_embedding | rotary/rope 类替代，参数不同 |
| 66 | `torch_npu.npu_kv_rmsnorm_rope_cache` | 是 | `4.3` | mindspore.ops.reshape_and_cache; mindspore.ops.... | 待确认/补充 golden 或 xfail 依据 |
| 67 | `torch_npu.npu_lightning_indexer` | 是 | `4.4` | mindspore.ops.lightning_indexer | 待确认/补充 golden 或 xfail 依据 |
| 68 | `torch_npu.npu_mhc_post` | 是 | `4.9`、`4.14` | - | 待确认/补充 golden 或 xfail 依据 |
| 69 | `torch_npu.npu_mhc_pre` | 是 | `4.9`、`4.14` | - | 待确认/补充 golden 或 xfail 依据 |
| 70 | `torch_npu.npu_mhc_sinkhorn` | 是 | `4.9`、`4.14` | - | 待确认/补充 golden 或 xfail 依据 |
| 71 | `torch_npu.npu_mla_prolog_v3` | 是 | `4.1`、`4.4` | mindspore.ops.mla; mindspore.ops.mla_preprocess | 待确认/补充 golden 或 xfail 依据 |
| 72 | `torch_npu.npu_moe_compute_expert_tokens` | 是 | `4.6` | mindspore.ops.moe_compute_expert_tokens | 代码已有，未对外；参数不同 |
| 74 | `torch_npu.npu_moe_distribute_combine_v2` | 是 | `4.7` | mindspore.ops.moe_distribute_combine | 代码已有，未对外；v2/参数可能不同 |
| 75 | `torch_npu.npu_moe_distribute_dispatch_v2` | 是 | `4.7` | mindspore.ops.moe_distribute_dispatch | 代码已有，未对外；v2/参数可能不同 |
| 76 | `torch_npu.npu_moe_finalize_routing` | 是 | `4.6` | mindspore.ops.moe_finalize_routing | 代码已有，未对外；参数不同 |
| 78 | `torch_npu.npu_moe_gating_top_k` | 是 | `4.6` | mindspore.ops.topkrouter | 代码已有，未对外；包含 softmax/top-k 语义，参数不同 |
| 80 | `torch_npu.npu_moe_gating_top_k_softmax` | 是 | `4.6` | mindspore.ops.moe_gating_top_k_softmax | 代码已有，未对外；参数不同 |
| 82 | `torch_npu.npu_moe_init_routing` | 是 | `4.6` | mindspore.ops.moe_init_routing_v2 | 代码已有，未对外；参数不同 |
| 84 | `torch_npu.npu_moe_init_routing_v2` | 是 | `4.6` | mindspore.ops.moe_init_routing_v2 | 代码已有，未对外；参数不同 |
| 85 | `torch_npu.npu_moe_re_routing` | 是 | `4.8` | mindspore.ops.moe_init_routing_v2 | 未找到单一对等接口；可按 MoE routing 流程拆分，需人工确认语义 |
| 87 | `torch_npu.npu_mrope` | 是 | `4.5` | mindspore.ops.rotary_position_embedding | mrope 需按多模态 rope 语义人工改写 |
| 88 | `torch_npu.npu_prefetch` | 是 | `4.14` | - | 待确认/补充 golden 或 xfail 依据 |
| 89 | `torch_npu.npu_quant_lightning_indexer` | 是 | `4.9`、`4.14` | - | 待确认/补充 golden 或 xfail 依据 |
| 90 | `torch_npu.npu_quant_matmul` | 是 | `4.9` | mindspore.ops.quant_matmul | 代码已有，未对外；Ascend 量化 matmul，参数不同 |
| 91 | `torch_npu.npu_rms_norm` | 是 | `4.5` | mindspore.ops.rms_norm | 待确认/补充 golden 或 xfail 依据 |
| 92 | `torch_npu.npu_rotary_mul` | 是 | `4.5` | mindspore.ops.rotary_position_embedding | rotary_mul 与 rotary_position_embeddin... |
| 93 | `torch_npu.npu_scatter_nd_update_` | 是 | `4.2` | mindspore.ops.scatter_nd_update | 需按 inplace 语义改写 |
| 94 | `torch_npu.npu_scatter_pa_kv_cache` | 是 | `4.2` | mindspore.ops.kv_cache_scatter_update | 待确认/补充 golden 或 xfail 依据 |
| 95 | `torch_npu.npu_swiglu` | 是 | `4.5` | mindspore.ops.swiglu | 待确认/补充 golden 或 xfail 依据 |
| 96 | `torch_npu.npu_top_k_top_p_sample` | 是 | `4.14` | mindspore.ops.topkrouter; mindspore.ops.topprouter | 待确认/补充 golden 或 xfail 依据 |
| 97 | `torch_npu.npu_transpose_batchmatmul` | 是 | `4.11` | mindspore.ops.matmul + mindspore.ops.transpose | 需拆分组合实现 |
| 98 | `torch_npu.torch.ops.custom.npu_ai_infra_quant_lightning_indexer` | 是，omni-ops-master | `4.9`、`4.14` | - | 待确认/补充 golden 或 xfail 依据 |

处理口径：

- 有 MindSpore 候选 API 的条目进入 `4.11` 参数语义和 dtype/layout 差异看护。
- 无单一对等接口的条目进入对应算子组的拆分验证，或进入 `4.14` unsupported/xfail 清单。
- `是，omni-ops-master` 和 `是，omni-ops-v1.5.0` 保留来源标签，便于区分 omni-ops 来源分支。
...
| **Dashboard 执行总计** | **170** | - | - | - | **0** |


Dashboard 执行口径：

- 文档 checkbox 设计口径仍为 126 个聚合验收项。
- Dashboard 执行口径为 170 个实际跟踪项：78 (`vllm_omni_npu`) + 34 (`omni_models`) + 58 (`ms_custom_ops` Row)。
...
> Dashboard 中 `4.1` - `4.14` 为折叠分组，不计入完成率；实际计数来自第 5.3 节的 58 个 Row 子项。

| Checkbox | 优先级 | 验收点 | 对应 5.3 Row | 逐项数 |
|---|---|---|---|---:|
| [ ] `4.1` | P0 | Attention fused/sink。 | 13, 21, 38, 40, 41, 42, 43, 48, 56, 58, 60, 71 | 12 |
